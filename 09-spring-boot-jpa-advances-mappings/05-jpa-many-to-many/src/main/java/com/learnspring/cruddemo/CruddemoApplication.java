...
//			deleteCourse(appDAO);
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		Course tempCourse1 = new Course("Chess");
		Course tempCourse2 = new Course("Running");
	...
	private void findStudentAndCourses(AppDAO appDAO) {
		...
		System.out.println("LoadingStudent : " + tempStudent);
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		Course tempCourse = new Course("Ride vehicle");

		Student tempStudent1 = new Student("John", "qqq", "qqq@gmai.com");
		Student tempStudent2 = new Student("Mary", "qqq", "qqq@gmai.com");
	...
	private void createCourseAndReviews(AppDAO appDAO) {
		Course tempCourse = new Course("Pacman- play");

		tempCourse.addReview(new Review("Great Course"));
		tempCourse.addReview(new Review("Good"));
		tempCourse.addReview(new Review("Okay, can do better"));
